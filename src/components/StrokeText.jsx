...
/*
 * Modificado respecto del original de React Bits: ScrollTrigger ya no se
 * importa arriba sino solo cuando trigger === 'scroll'. Con trigger="mount"
 * el plugin nunca se usa, y estaticamente sumaba ~20 kB comprimidos a la
 * pagina que se abre desde el QR del poster.
 */
    ...
    if (trigger === 'hover') {
      ...
      if (trigger === 'scroll') {
        import('gsap/ScrollTrigger')
          ...
          .catch(() => {
            // Si el plugin no carga, se muestra dibujado en vez de nada.
